...
<body>
    ...
    <div class="container mt-3">
        <div class="jumbotron">
            ...
            <p class="lead">Aquí tienes nuestras recetas navideñas de diferentes países.</p>
            <hr class="my-4">
            ...
            <div class="col-sm-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-danger">Receta Alemania</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mb-3">
            ...
            <div class="col-sm-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-danger">Receta Portugal</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-danger">Receta Rusia</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-danger">Receta Suecia</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-danger">Receta Francia</a>
                    </div>
                </div>
            </div>
        </div>
